...
<style type="text/css">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4><i class="fa fa-user " style="font-size: larger!important;"></i> My Profile</h4>
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>Nama</td>
                ...
                <form method="POST" action="{{ url('profile') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                is-invalid @enderror" name="name" value="{{ $user->name }}" required autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nohp" type="text" class="form-control @error('nohp') 
                                is-invalid @enderror" name="nohp" value="{{ $user->nohp }}" required autocomplete="nohp" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea name="alamat" class="form-control @error('alamat') 
                                 is-invalid @enderror" required="">{{ $user->alamat }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name=
